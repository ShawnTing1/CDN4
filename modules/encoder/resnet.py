...
class ResNet(nn.Module):
    ...
    def __init__(self, block=BasicBlock, drop_rate=0.0, dropblock_size=3):
        ...
        self.conv_layer_3202640 = nn.Conv2d(in_channels=320, out_channels=640, kernel_size=1, stride=1)
        self.conv_layer_1602640 = nn.Conv2d(in_channels=160, out_channels=640, kernel_size=5, stride=2, padding=1)
    ...
    def forward(self, x):
        x = self.layer1(x)
        x_21 = self.layer2(x)
        x_21_640 = self.conv_layer_1602640(x_21)
        x_10_1 = self.layer3(x_21) 
        x_10_1_640 = self.conv_layer_3202640(x_10_1)
        x_10_2 = self.layer4(x_10_1) 
        x=x_10_2+x_21_640+x_10_1_640
        

        return x

@registry.Encoder.register("R12")
def resnet12():
    return ResNet(BasicBlock)

@registry.Encoder.register("R12-pre")
def resnet12():
    return ResNet(BasicBlock, drop_rate=0.1, dropblock_size=5)
